...
__turbopack_context__.s([
    "400afcb1ff9f3df86066daf9aa584849807d4593b3",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["submitVoterApplication"],
    "4066d537bccca1902d7cbd4d0a72356ea99c031365",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["trackApplication"]
]);
...
return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {
/* __next_internal_action_entry_do_not_use__ [{"00825246c1a5a0373bb3c63d0a377df2cda8f2b624":{"name":"getAdminDashboardData"},"400afcb1ff9f3df86066daf9aa584849807d4593b3":{"name":"submitVoterApplication"},"402e0d83fdf1dda137cd54cdc758217ffd49522a97":{"name":"reviewApplication"},"4066d537bccca1902d7cbd4d0a72356ea99c031365":{"name":"trackApplication"}},"src/app/actions.ts",""] */ __turbopack_context__.s([
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/normalization.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$anomalyEngine$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/anomalyEngine.ts [app-rsc] (ecmascript)");
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
async function submitVoterApplication(data) {
    try {
        if (!data.fullName || !data.dateOfBirth || !data.address || !data.pincode || !data.email || !data.mobile) {
            return {
                success: false,
                error: "Please fill out all required application fields."
            };
        }
        const applicationNumber = `VOT-2026-${Math.floor(10000 + Math.random() * 90000)}`;
        const normName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(data.fullName);
        // Retrieve existing voters and applications for cross-screening
        const existingVoters = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voter.findMany();
        const existingApplications = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findMany();
        // Run 10 Anomaly Signal Engine
        const analysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$anomalyEngine$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["runAnomalyEngine"])({
        ...
        }, existingVoters, existingApplications);
        const initialStatus = analysis.overallRiskScore >= 30 ? "FLAGGED_DUPLICATE" : "PENDING";
        const createdApp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.create({
            data: {
                applicationNumber,
                fullName: data.fullName,
                ...
                anomalyBreakdown: analysis.anomalyBreakdown
            }
        });
        if (analysis.overallRiskScore >= 30 && analysis.matchedVoterName) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].duplicateFlag.create({
                data: {
                    applicationId: createdApp.id,
                    matchedVoterId: analysis.matchedVoterId || null,
                    matchedVoterName: analysis.matchedVoterName,
                    matchedVoterDetails: analysis.matchedVoterDetails || {},
                    overallScore: analysis.overallRiskScore,
                    fieldBreakdown: analysis.anomalyBreakdown
                }
            });
        }
        ...
        return {
            success: false,
            error: "Application submission could not be processed. Please check your information and try again."
        };
    }
}
async function trackApplication(query) {
    try {
        ...
        if (!trimmed) {
            return {
                success: false,
                error: "Please provide an application number or email."
            };
        }
        const application = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findFirst({
            where: {
                OR: [
                    {
                        applicationNumber: {
        ...
        if (!application) {
            return {
                success: false,
                error: "No voter application found matching your query."
            };
        }
        // Retrieve generated Voter ID if approved
        let voterIdNumber = null;
        if (application.status === "APPROVED") {
            const voter = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voter.findFirst({
                where: {
        ...
        return {
            success: false,
            error: "Failed to query application status."
        };
    }
}
async function getAdminDashboardData() {
    try {
        const applications = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findMany({
            include: {
                flags: true,
                auditLogs: {
                    orderBy: {
        ...
        const auditLogs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].auditLog.findMany({
            include: {
                application: {
                    select: {
...
async function reviewApplication(data) {
    try {
        ...
        const application = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findUnique({
            where: {
                id: applicationId
            }
        });
        if (!application) {
            return {
                success: false,
                error: "Target voter application not found."
            };
        }
        if (decision !== "APPROVED" && (!officerNotes || !officerNotes.trim())) {
            return {
                success: false,
                error: "Officer notes are mandatory for rejections and verification requests."
            };
        }
        let generatedVoterId = null;
        if (decision === "APPROVED") {
            generatedVoterId = `VID-2026-${Math.floor(100000 + Math.random() * 900000)}`;
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.update({
                where: {
                    id: applicationId
                },
                data: {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voter.create({
                data: {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(submitVoterApplication, "400afcb1ff9f3df86066daf9aa584849807d4593b3", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(trackApplication, "4066d537bccca1902d7cbd4d0a72356ea99c031365", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getAdminDashboardData, "00825246c1a5a0373bb3c63d0a377df2cda8f2b624", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(reviewApplication, "402e0d83fdf1dda137cd54cdc758217ffd49522a97", null);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
"[project]/src/lib/anomalyEngine.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function calculateStringSimilarity(s1, s2) {
    const str1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(s1);
    const str2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(s2);
...
function runAnomalyEngine(applicant, existingVoters, existingApplications) {
    const normApp = {
        ...applicant,
        normalizedName: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(applicant.fullName),
        normalizedRelative: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(applicant.relativeName || ""),
        normalizedAddress: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(applicant.address),
        dobStr: applicant.dateOfBirth instanceof Date ? applicant.dateOfBirth.toISOString().split("T")[0] : new Date(applicant.dateOfBirth).toISOString().split("T")[0]
    };
    const anomalyBreakdown = [];
    let topMatchedRecord = null;
    let topMatchScore = 0;
    // Combine existing DB records for comparison
    const allRecords = [
        ...existingVoters.map((v)=>({
                ...v,
                recordType: "Voter",
    ...
    let multRegReason = "";
    let multRegMatch = null;
    let multRegSimilarity = 0;
    for (const rec of allRecords){
        const recNormName = rec.normalizedName || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(rec.fullName);
        const nameSim = calculateStringSimilarity(normApp.normalizedName, recNormName);
        const recDobStr = rec.dateOfBirth instanceof Date ? rec.dateOfBirth.toISOString().split("T")[0] : new Date(rec.dateOfBirth).toISOString().split("T")[0];
        const dobMatch = recDobStr === normApp.dobStr;
        const recNormAddr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(rec.address);
    ...
    let dseFlag = false;
    let dseReason = "";
    let dseMatchRec = null;
    if (normApp.relativeName) {
        for (const rec of allRecords){
            const recRel = rec.normalizedRelative || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(rec.relativeName);
            const relSim = calculateStringSimilarity(normApp.normalizedRelative, recRel);
            const nameSim = calculateStringSimilarity(normApp.normalizedName, rec.normalizedName || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(rec.fullName));
    ...
    anomalyBreakdown.push({
        ...
        reason: mobileFlag ? `Mobile number ${normApp.mobile} is used across ${mobileCount} different applications.` : `Mobile number frequency (${mobileCount} usage) is within acceptable bounds.`
    });
    // ==========================================
    ...
    for (const rec of allRecords){
        ...
        const addrSim = calculateStringSimilarity(normApp.normalizedAddress, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(rec.address));
    ...
    anomalyBreakdown.push({
        ...
        reason: addrFlag ? `Unusual concentration of ${addrCount} applications at address "${normApp.address}".` : `Address registration density (${addrCount} records) is normal.`
    });
    // ==========================================
    // DETECTOR 7: SUSPICIOUS NAME / INPUT ANOMALY (5 pts)
    // ==========================================
    const suspResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isSuspiciousName"])(normApp.fullName);
    ...
    anomalyBreakdown.push({
        ...
        reason: nameFlag ? suspResult.reason || "Suspicious or malformed characters detected in name." : "Applicant name string formatting passed validation."
    });
    // ==========================================
    ...
    let deadShiftedMatch = null;
    for (const v of existingVoters){
        if (v.isDeadOrShifted) {
            const nameSim = calculateStringSimilarity(normApp.normalizedName, v.normalizedName || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$normalization$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["normalizeName"])(v.fullName));
            if (nameSim >= 0.85) {
    ...
    anomalyBreakdown.push({
        ...
        scoreContribution: 0,
        reason: deadShiftedFlag ? `Applicant matches voter record ${deadShiftedMatch?.voterIdNumber} marked as Shifted / Deceased.` : "No match against shifted/deceased elector registry.",
    ...
    anomalyBreakdown.push({
        ...
        scoreContribution: 0,
        reason: integrityFlag ? `Missing or malformed mandatory fields: ${missingFields.join(", ")}.` : "Application contains all required mandatory fields."
    });
    // ==========================================
    // OVERALL RISK SCORE & LEVEL CLASSIFICATION
    // ==========================================
    const overallRiskScore = Math.min(100, anomalyBreakdown.reduce((sum, item)=>sum + item.scoreContribution, 0));
    let riskLevel = "LOW";
...
"[project]/src/lib/normalization.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function normalizeText(input) {
    if (!input) return "";
    return input.toLowerCase().trim().replace(/[.,/#!$%^&*;:{}=\-_`~()"'`]/g, "") // Remove harmless punctuation
...
function isSuspiciousName(name) {
    if (!name || name.trim().length < 2) {
        return {
            isSuspicious: true,
            reason: "Name string is empty or under 2 characters."
        };
    }
    ...
    if (/^[0-9]/.test(trimmed)) {
        return {
            isSuspicious: true,
            reason: `Malformed string starts with numbers ("${trimmed}").`
        };
    }
    ...
    if (/[@#$%^&*()_+=\[\]{};:"\\|<>?/~`]/.test(trimmed)) {
        return {
            isSuspicious: true,
            reason: `Contains invalid special symbols ("${trimmed}").`
        };
    }
    ...
    if (digits > 0 && digits / trimmed.length > 0.2) {
        return {
            isSuspicious: true,
            reason: `High concentration of numeric characters ("${trimmed}").`
        };
    }
    ...
    if (/(.)\1{4,}/i.test(trimmed)) {
        return {
            isSuspicious: true,
            reason: `Excessive repetitive characters ("${trimmed}").`
        };
    }
    return {
        isSuspicious: false
...
;
;
const connectionString = process.env.DATABASE_URL || "postgresql://localhost:5432/voter_portal";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0344z1q._.js.map