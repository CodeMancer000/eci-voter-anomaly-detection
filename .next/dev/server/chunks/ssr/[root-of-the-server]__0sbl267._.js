...
__turbopack_context__.s([
    "00825246c1a5a0373bb3c63d0a377df2cda8f2b624",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAdminDashboardData"],
    "402e0d83fdf1dda137cd54cdc758217ffd49522a97",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["reviewApplication"]
]);
...
async function submitVoterApplication(data) {
    try {
        ...
        const existingVoters = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voter.findMany();
        const existingApplications = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findMany();
        ...
        const createdApp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.create({
            data: {
                applicationNumber,
                fullName: data.fullName,
        ...
        if (analysis.overallRiskScore >= 30 && analysis.matchedVoterName) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].duplicateFlag.create({
                data: {
...
async function trackApplication(query) {
    try {
        ...
        const application = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findFirst({
            where: {
                OR: [
                    {
                        applicationNumber: {
        ...
        if (application.status === "APPROVED") {
            const voter = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voter.findFirst({
                where: {
...
async function getAdminDashboardData() {
    try {
        const applications = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findMany({
            include: {
                flags: true,
                auditLogs: {
                    orderBy: {
        ...
        const auditLogs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].auditLog.findMany({
            include: {
                application: {
                    select: {
...
async function reviewApplication(data) {
    try {
        ...
        const application = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findUnique({
            where: {
                id: applicationId
            }
        });
        ...
        if (decision === "APPROVED") {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.update({
                where: {
                    id: applicationId
                },
                data: {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voter.create({
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0sbl267._.js.map