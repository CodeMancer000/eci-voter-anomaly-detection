...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$duplicateEngine$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/duplicateEngine.ts [app-rsc] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$duplicateEngine$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$duplicateEngine$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
async function submitVoterApplication(input) {
    try {
        // Input validation
        if (!input.fullName.trim() || !input.dateOfBirth || !input.address.trim()) {
            return {
                success: false,
        ...
        // Check if exact same application number or duplicate email already has an active pending app
        const existingActive = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findFirst({
            where: {
        ...
        if (existingActive) {
            return {
                success: false,
                error: `An active application (${existingActive.applicationNumber}) already exists for this email address. Please track your existing application status.`
            };
        }
        // Generate unique Application Number
        const randomNum = Math.floor(10000 + Math.random() * 90000);
        const applicationNumber = `VOT-2026-${randomNum}`;
        // Execute Duplicate Detection Engine
        const dupResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$duplicateEngine$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["runDuplicateDetection"])({
        ...
        const status = dupResult.isDuplicateFlagged ? "FLAGGED_DUPLICATE" : "PENDING";
        const dobDate = new Date(input.dateOfBirth);
        // Create VoterApplication in database
        const newApp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.create({
            data: {
                applicationNumber,
                ...
                status,
                duplicateScore: dupResult.highestMatchScore
            }
        });
        // Create Audit Log & DuplicateFlag if potential match detected
        if (dupResult.isDuplicateFlagged && dupResult.fieldBreakdown) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].duplicateFlag.create({
                data: {
                    ...
                    matchedVoterId: dupResult.matchedVoterId || null,
                    matchedVoterName: dupResult.matchedVoterName || "Existing Record",
                    matchedVoterDetails: dupResult.matchedVoterDetails || {},
                    overallScore: dupResult.highestMatchScore,
                    fieldBreakdown: dupResult.fieldBreakdown
                }
            });
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].auditLog.create({
                data: {
                    applicationId: newApp.id,
                    action: "FLAGGED_POTENTIAL_DUPLICATE",
                    performedBy: "SYSTEM_DUPLICATE_ENGINE",
                    notes: `Application flagged with ${dupResult.highestMatchScore}% similarity score to existing voter (${dupResult.matchedVoterName}). Routed to human electoral officer for review.`
                }
            });
        } else {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].auditLog.create({
                data: {
                    ...
                    action: "SUBMITTED",
                    performedBy: "SYSTEM",
                    notes: "Voter application received successfully. Queued for standard verification."
                }
            });
        }
        return {
            ...
            applicationNumber,
            status,
            isDuplicateFlagged: dupResult.isDuplicateFlagged,
            matchScore: dupResult.highestMatchScore
        };
    } catch (error) {
        console.error("Error submitting voter application:", error);
        return {
            success: false,
            error: "Failed to submit voter application. Please try again."
        };
    }
}
async function trackApplication(queryInput) {
    const query = queryInput.trim();
    if (!query) {
        return {
            success: false,
            error: "Please enter an application number or email."
        };
    }
    try {
        const app = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findFirst({
            where: {
                OR: [
                    {
                        applicationNumber: {
        ...
        if (!app) {
            return {
                success: false,
                error: "No voter application found matching your details."
            };
        }
        // Check if an official voter ID was generated
        const approvedVoter = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voter.findFirst({
            where: {
                email: app.email
            }
        });
        return {
            ...
            application: {
                ...
                mobile: app.mobile,
                status: app.status,
                duplicateScore: app.duplicateScore,
                createdAt: app.createdAt.toISOString(),
                voterIdNumber: approvedVoter?.voterIdNumber || null,
                flags: app.flags,
...
async function getAdminDashboardData() {
    try {
        const totalApplications = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.count();
        const pendingCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.count({
            where: {
                status: "PENDING"
            }
        });
        const flaggedCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.count({
            where: {
                status: "FLAGGED_DUPLICATE"
            }
        });
        const approvedCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.count({
            where: {
                status: "APPROVED"
            }
        });
        const rejectedCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.count({
            where: {
                status: "REJECTED"
            }
        });
        const totalVoters = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voter.count();
        ...
        return {
            ...
            auditLogs: auditLogs.map((log)=>({
                    ...
                    applicantName: log.application.fullName,
                    action: log.action,
                    performedBy: log.performedBy,
                    notes: log.notes,
                    createdAt: log.createdAt.toISOString()
...
async function reviewApplication({ applicationId, decision, officerNotes, officerName }) {
    try {
        const app = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findUnique({
            where: {
                id: applicationId
            }
        });
        ...
        const reviewer = officerName?.trim() || "Electoral Officer";
        const notes = officerNotes?.trim() || (decision === "APPROVED" ? "Verified and approved by officer." : "Rejected during manual review.");
        if (decision === "APPROVED") {
            const randomNum = Math.floor(100000 + Math.random() * 900000);
            const voterIdNumber = `VID-2026-${randomNum}`;
            // Create official voter record
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].auditLog.create({
                data: {
                    ...
                    notes: `${notes} Official Voter ID ${voterIdNumber} generated.`
                }
            });
            return {
                success: true,
...
"[project]/src/lib/duplicateEngine.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function calculateStringSimilarity(str1, str2) {
    ...
    for(let j = 1; j <= len2; j += 1){
        for(let i = 1; i <= len1; i += 1){
            ...
            track[j][i] = Math.min(track[j][i - 1] + 1, track[j - 1][i] + 1, track[j - 1][i - 1] + indicator // substitution
            );
        }
    }
...
function calculateDobSimilarity(dobStr1, dobStr2) {
...
function calculatePincodeSimilarity(pin1, pin2) {
    const p1 = pin1.trim();
    const p2 = pin2.trim();
    if (p1 === p2) return 1.0;
...
function calculateContactSimilarity(email1, mobile1, email2, mobile2) {
...
async function runDuplicateDetection(input) {
    const voters = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voter.findMany();
    const pendingApps = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].voterApplication.findMany({
        where: {
            status: {
                in: [
                    "PENDING",
    ...
    let highestScore = 0;
    let bestMatchVoter = null;
    let bestFieldBreakdown = null;
    ...
    const evaluateRecord = (record)=>{
        ...
        const contactScore = calculateContactSimilarity(input.email, input.mobile, record.email, record.mobile);
        // Weights: Name 35%, DOB 25%, Address 20%, Pincode 10%, Contact 10%
        const totalScore = nameScore * 0.35 + dobScore * 0.25 + addressScore * 0.2 + pincodeScore * 0.1 + contactScore * 0.1;
        const flagReasons = [];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0y9olvh._.js.map